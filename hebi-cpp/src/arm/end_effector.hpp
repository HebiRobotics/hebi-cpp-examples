...
protected:
  ...
  EndEffector(std::shared_ptr<hebi::Group> group) : command_(AuxSize), feedback_(AuxSize), group_(group) { }
...
// 
// auto end_effector = EffortEndEffector<1>::create("HEBI", "Gripper");
...
public:
  ...
  Eigen::VectorXd getState() {
    return this->feedback_.getEffort();
  }
