...
Info::FloatField::operator bool() const { return has(); }
...
Info::HighResAngleField::operator bool() const { return has(); }
...
Info::StringField::operator bool() const { return has(); }
...
Info::FlagField::operator bool() const { return has(); }
...
const Info::LedField& Info::led() const { return led_; }
