...
Command::FloatField::operator bool() const { return has(); }
...
Command::HighResAngleField::operator bool() const { return has(); }
...
Command::StringField::operator bool() const { return has(); }
...
Command::FlagField::operator bool() const { return has(); }
...
Command::NumberedFloatField& Command::debug() { return debug_; }
Command::FlagField& Command::reset() { return reset_; }
Command::FlagField& Command::boot() { return boot_; }
Command::FlagField& Command::stopBoot() { return stop_boot_; }
Command::LedField& Command::led() { return led_; }
